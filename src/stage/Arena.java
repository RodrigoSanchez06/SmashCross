...
/**
 * Define un objeto de tipo arena, en donde se transmiten acontecimientos de una
 * pelea a los espectadores.
 */
public class Arena implements Subject {
    ...
    /**
     * Verifica para cada usuario si su peleador favorito es ganador o no.
     * 
     * @param winner peleador ganador.
     */
